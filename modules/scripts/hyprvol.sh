...
# credit to Dregu https://gist.github.com/Dregu/aa748bebc7c3aeddd3ceb55c0f046c5d    

# control active window pipewire volume with hyprland binds
# tries really hard to figure out complex situations like:
# - individual firefox tabs/windows
# - gamescope games
# - proton games
# - child process playing audio in terminal window
# - multiple streams per process
...
# gather data
CMD="$*"  # fix SC2124: use $* instead of $@ when assigning to string

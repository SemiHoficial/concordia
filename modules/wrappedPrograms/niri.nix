    ...
    config = {
      ...
      in {
        ...
        binds = {
          ...
          "Mod+B".spawn-sh = "mute-active toggle";
          ...
          # brightness
          "XF86MonBrightnessUp".spawn-sh = "${lib.getExe pkgs.brightnessctl} -e4 -n2 set 5%+";
          "XF86MonBrightnessDown".spawn-sh = "${lib.getExe pkgs.brightnessctl} -e4 -n2 set 5%-";
